...
type ChildFormProps = {
	createInvoice: (values: any) => void; // onSubmit function passed from the parent
	formikSubmitRef: React.MutableRefObject<(() => void) | null>; // Ref to expose submitForm method to parent
};

const NewInvoice = ({ createInvoice, formikSubmitRef }: ChildFormProps) => {
	return (
